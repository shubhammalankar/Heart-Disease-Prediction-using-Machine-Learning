...
class Execute(object):
            ...
            def setupUi(self, MainWindow):
                ...
                self.label_8.setStyleSheet("font: 16pt \"Cambria\";")
                if prediction == 0:
                ...
                self.label_9.setStyleSheet("font: 16pt \"Cambria\";")
                if prediction1 == 0:
                    self.label_9.setText("No")
                else:
                    self.label_9.setText("Yes")
            ...
            def retranslateUi(self, MainWindow):
                ...
                # self.label_8.setText(str(secondpage.prediction))
